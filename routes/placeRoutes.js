...
// Import các thư viện và middleware
import express from 'express';  // Chuyển từ require sang import
import {auth} from '../middleware/auth.js';  // Thêm .js khi sử dụng ESM
import {Place} from '../models/PlaceFeature.js'; 
const router = express.Router();
